  ...
  return (
    <div className="    ">
      ...
      <div className=" " style={{borderBottom:'1px solid black'}}>
        <div className="flex justify-between bg-gradient-to-t from from-white to-yellow-500 
        ...
        ">
          ...
          <div className="flex max-sm:hidden">
            <img className="w-full h-full object-cover "  alt="coverPhoto" src="https://images.unsplash.com/photo-1519337265831-281ec6cc8514?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"/>
          </div>
        </div>
      </div>
