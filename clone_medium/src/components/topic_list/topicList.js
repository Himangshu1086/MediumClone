...
function TopicList() {
  ...
  return (
    <div>
       ...
       <div className="flex max-sm:mr-0 flex-wrap mr-10 w-full justify-center ">
          {posts.map((post) => {
            return (
              <Link to={post.id} className=' flex p-5 max-sm:flex-col max-sm:w-3/5 justify-center bg-gray-100 shadow-lg shadow-black-500/50 mb-8 mr-4 w-1/3  hover:bg-purple-200 hover:ease-in duration-300 hover:scale-95'>
                ...
                <div className="p-2 m-2 rounded-md w-96 max-sm:w-full max-sm:m-0 h-72 max-sm:h-auto">
                  ...
                  <div className="w-full text-justify  mt-1 mb-1 h-20 max-sm:h-10 ">
                    <p className='text-lg'>{post.postData}</p>
                  </div>

                  <div className="w-full mt-4 max-sm:mt-20">
